...
//        ChangeActivity
        ...
        nv.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                {
                    case R.id.home:
//                        Toast.makeText(WifiActivity.this, "berhasil", Toast.LENGTH_SHORT).show();
//                        return true;
                        Intent mtintent1 = new Intent(WifiActivity.this, MainActivity.class);
                        startActivity(mtintent1);
                        return true;
                    case R.id.wifi:
//                        Intent mtintent = new Intent(WifiActivity.this, WifiActivity.class);
